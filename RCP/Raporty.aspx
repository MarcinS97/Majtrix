<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Raporty.aspx.cs" Inherits="HRRcp.RaportyForm" %>
        ...
        <div class="pageContent">
            <div class="center">
                ...
                <div id="paAll" runat="server" visible="false">
                    <asp:Label ID="lbAllTitle" runat="server" CssClass="title" Text="Zestawienia dla wszystkich CC"></asp:Label>
