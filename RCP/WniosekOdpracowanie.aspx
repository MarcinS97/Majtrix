<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="WniosekOdpracowanie.aspx.cs" Inherits="HRRcp.WniosekOdpracowanie" %>
...
<%--    <link href="styles/print.css" rel="stylesheet" type="text/css" media="print" runat="server" id="headPrint" />--%>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderReport" runat="server">
    ...
    <div class="page960 pgWniosekWolneZaNadg">
        <div class="border">
            ...
            <uc2:cntWniosekOdpracowanie runat="server" id="cntWniosekOdpracowanie2" Visible="false" />
        </div>
    </div>
