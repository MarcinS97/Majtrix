<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntPrzypisaniaParametry.ascx.cs" Inherits="HRRcp.Controls.Przypisania.cntPrzypisaniaParametry" %>
