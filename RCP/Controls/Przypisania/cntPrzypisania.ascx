<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntPrzypisania.ascx.cs" Inherits="HRRcp.Controls.Przypisania.cntPrzypisania" %>
...
<div id="paFilter" runat="server" class="paFilter" visible="true">
    ...
    <asp:DropDownList ID="ddlKierownikOd" runat="server" DataSourceID="SqlDataSourceKier" DataTextField="Kierownik" DataValueField="Id" AutoPostBack="true" OnSelectedIndexChanged="cnt_ChangeFilter" >
    </asp:DropDownList><br />
    <span class="label">Do kierownika:</span>
    <asp:DropDownList ID="ddlKierownikDo" runat="server" DataSourceID="SqlDataSourceKier" DataTextField="Kierownik" DataValueField="Id" AutoPostBack="true" OnSelectedIndexChanged="cnt_ChangeFilter" >
    </asp:DropDownList><br />
