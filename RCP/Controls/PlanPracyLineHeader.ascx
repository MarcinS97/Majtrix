<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PlanPracyLineHeader.ascx.cs" Inherits="HRRcp.Controls.PlanPracyLineHeader" %>

<asp:HiddenField ID="hidFrom" runat="server" />
<asp:HiddenField ID="hidTo" runat="server" />
<asp:HiddenField ID="hidHeaderData" runat="server" />
