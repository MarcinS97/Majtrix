<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdmLogControl.ascx.cs" Inherits="HRRcp.Controls.AdmLogControl" %>
...
<asp:ListView ID="lvEvents" runat="server" DataKeyNames="Id" 
    ...
    <ItemTemplate>
        <tr class="it" style="">
            ...
            <td class="col5">
                <asp:TextBox class="textbox noborder form-control" ID="InfoLabel" runat="server" Text='<%# Eval("Info") %>' TextMode="MultiLine" Rows="3" ReadOnly="True" />
            </td>
            <td class="col6">
                <asp:TextBox class="textbox noborder form-control" ID="Info2TextBox" runat="server" Text='<%# Eval("Info2") %>' TextMode="MultiLine" Rows="3" ReadOnly="True" />
            </td>
            <td class="col7">
    ...
    <LayoutTemplate>
        <div id="divLog" runat="server">
            <table id="Table4" class="ListView1 hoverline" runat="server">
                <tr id="Tr1" runat="server"  class="pager pager_top">
                ...
                <tr id="Tr4" runat="server">
                    <td id="Td3" colspan="2" runat="server">
                        <table class="tbLog table" ID="itemPlaceholderContainer" runat="server" border="0" style="">
                ...
                <tr id="Tr6" runat="server"  class="pager">
