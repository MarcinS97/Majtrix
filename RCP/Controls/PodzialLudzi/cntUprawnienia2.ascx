<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntUprawnienia2.ascx.cs" Inherits="HRRcp.Controls.PodzialLudzi.cntUprawnienia2" %>
...
<div id="paUprawnienia" runat="server" class="cntUprawnienia">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="tabsline">
                <asp:Menu ID="tabTyp" CssClass="printoff" runat="server" Orientation="Horizontal" Visible="true"
                    onmenuitemclick="tabTyp_MenuItemClick" >
                    ...
                    <Items>
                        <asp:MenuItem Text="Podział Ludzi" Value="1" Selected="true"></asp:MenuItem>
                        <asp:MenuItem Text="Limity" Value="2" ></asp:MenuItem>
                    </Items>
                    <StaticItemTemplate>
            ...
            <asp:GridView ID="gvUprawnienia" runat="server" CssClass="GridView1" DataSourceID="SqlDataSource1" DataKeyNames="nrew:-" 
                AllowPaging="True" AllowSorting="True" AutoGenerateColumns="true"                 
                ondatabound="gvUprawnienia_DataBound" 
                onrowcreated="gvUprawnienia_RowCreated"                
                >
            </asp:GridView>
            <div class="pagerline">
                <div class="pager">
...
<asp:SqlDataSource ID="SqlDataSourceA" runat="server" ConnectionString="<%$ ConnectionStrings:HRConnectionString %>" 
    onload="SqlDataSource1_Load" 
    onselected="SqlDataSource1_Selected"    
    SelectCommand="
declare 
...
SELECT 
	...
	case when dbo.GetRightId(Rights, 40) = 1 then ''x'' else ''-'' end [Raport PM|js:setPrawaCC(this 1 @pid 40);|Dostęp do raportów dla PM],
...
<asp:SqlDataSource ID="SqlDataSourceB" runat="server" ConnectionString="<%$ ConnectionStrings:HRConnectionString %>" 
...
set @colsH = '[ED]'
set @colsD = '[ED] as [Edycja Limitów]'
