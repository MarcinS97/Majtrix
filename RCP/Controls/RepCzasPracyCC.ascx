<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RepCzasPracyCC.ascx.cs" Inherits="HRRcp.Controls.RepCzasPracyCC" %>
...
<div class="tabsContentLine" style="border-collapse:collapse; background-color:#FFF;">
    <asp:MultiView ID="mvRaporty" runat="server" ActiveViewIndex="0">
        ...
        <%-----------------------------------%>
            <uc1:RepNadgodziny ID="repNadgodziny" Mode="6" runat="server" />
        </asp:View>

        <%-----------------------------------%>
        <asp:View ID="vCzasDni" runat="server" >
        <%-----------------------------------%>
            <uc1:RcpControl ID="repDni" Mode="6" runat="server" />
        </asp:View>
