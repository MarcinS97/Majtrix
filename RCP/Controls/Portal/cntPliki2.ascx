<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntPliki2.ascx.cs" Inherits="HRRcp.Controls.Portal.cntPliki2" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register src="cntPlikiPliki.ascx" tagname="cntPlikiPliki" tagprefix="uc1" %>

<div id="paPliki" runat="server" class="cntPliki2">
...
--%>
    ...
    <asp:ListView ID="lvNaglowki" runat="server" DataKeyNames="Id" DataSourceID="SqlDataSource1" 
        InsertItemPosition="None"
        ondatabinding="lvNaglowki_DataBinding" 
        ondatabound="lvNaglowki_DataBound" 
        onitemcommand="lvNaglowki_ItemCommand" 
        onitemdatabound="lvNaglowki_ItemDataBound" 
        onitemdeleted="lvNaglowki_ItemDeleted" 
        onitemdeleting="lvNaglowki_ItemDeleting" 
        ...
        onitemcreated="lvNaglowki_ItemCreated">
        <ItemTemplate>
            <div class="line line_it">
                <div id="paGrupa" runat="server" class="grupa" visible='<%# IsVisible(Eval("Par2"), "1") %>'>
                    <div runat="server" id="paIco" visible='<%# IsIco(Eval("Image")) %>' class="ico">
                ...
                <div id="paPlik" runat="server" class="plik" visible='<%# IsVisible(Eval("Par2"), "2") %>'>
                
                </div>
                
                <uc1:cntPlikiPliki ID="cntPlikiPliki1" runat="server" ParentId='<%# Eval("Id") %>' Grupa='<%# Grupa %>' Mode='<%# Mode %>'/>    
                
                <div id="paButtons" runat="server" class="buttons" visible='<%# IsEditable %>'>        
                    <div class="left">
            ...
            <div class="grupa grupa_eit">
                ...
                <div class="gbuttons">        
                    <div class="left">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:CheckBox ID="AktywnyCheckBox" runat="server" Checked='<%# Bind("Aktywny") %>' Text="Widoczny" />
                    </div>
...
--%>
    ...
    --%>
        ...
        <LayoutTemplate>
            ...
            <div class="buttons">
                <asp:Button ID="Button3" runat="server" CommandName="NewRecord" Text="Dodaj grupę" />            
                <asp:Button ID="Button4" runat="server" CommandName="NewRecord" Text="Dodaj plik" />
                            
                <asp:Button ID="btCancelEdit" runat="server" CssClass="button125" Text="Zakończ edycję" OnClick="btCancelEdit_Click"/>
            </div>
        </LayoutTemplate>
    </asp:ListView>
