...
namespace HRRcp.Controls.Portal
{
    public partial class cntWnioskiUrlopowe : System.Web.UI.UserControl
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            Tools.PrepareDicListView(lvWnioski, 0, true, logUpdate, true);
...
and W.StatusId = @stAcc
                ...
                ", String.IsNullOrEmpty(App.User.OriginalId) ? "0" : App.User.OriginalId, cntWniosekUrlopowy.stAccepted, cntWniosekUrlopowy.stAcceptedHR));   //20161101 uruchamiane w schedulerze z nie istniejącego usera (np svcjgb_crpt w iQor) OriginalId zwraca null
            return ok;
            /*
