<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntArticles.ascx.cs" Inherits="HRRcp.Controls.Portal.cntArticles" %>
...
<asp:ListView ID="lvArtykuly" runat="server" DataKeyNames="Id" DataSourceID="SqlDataSource1" 
        ...
        onitemcreated="lvArtykuly_ItemCreated" ondatabound="lvArtykuly_DataBound" 
        onitemcanceling="lvArtykuly_ItemCanceling" 
        onitemcommand="lvArtykuly_ItemCommand" onitemdeleted="lvArtykuly_ItemDeleted" 
        onitemediting="lvArtykuly_ItemEditing" oniteminserted="lvArtykuly_ItemInserted" 
