<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="dbField.ascx.cs" Inherits="HRRcp.Controls.Portal.dbField" %>
...
<div id="paField" class="dbField" runat="server">
    ...
    <asp:DropDownList ID="ddlValue" class="value form-control" runat="server" Visible="false" onselectedindexchanged="ddlValue_SelectedIndexChanged" >
    </asp:DropDownList>
