...
{
    public partial class cntGazetkaAdm : System.Web.UI.UserControl
    {
        const int moQuery = 0;
        const int moEdit = 1;
        ...
        {
            Tools.PrepareDicListView(lvPliki, 0);
        }
...
{8}", 
        ...
        */
        ...
        protected void lvPliki_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            switch (e.CommandName)
            {
                ...
                case "Download":
                    ...
                    DataRow dr = db.getDataRow(con, "select * from SqlMenu where Id = " + e.CommandArgument.ToString());
                    db.Disconnect(con);
        ...
        {
            string fn = values["Command"].ToString();
