...
<asp:TextBox ID="tbSearch" runat="server" style=" width: 350px; margin: 0px; "  CssClass="search textbox"></asp:TextBox> <asp:Button ID="Button3" runat="server"  Text="Czyść"  CssClass="button75" 
