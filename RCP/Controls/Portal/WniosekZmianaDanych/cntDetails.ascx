<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntDetails.ascx.cs" Inherits="HRRcp.Controls.Reports.cntDetails2" %>
...
<div id="paDetails" runat="server" class="report_page">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:DetailsView ID="dvDetails" runat="server" CssClass="DetailsView1"
