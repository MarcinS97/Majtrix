...
{
    public partial class Urlop : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
#if CO
                gvLimity.DataSourceID = "SqlDataSource3";
                SqlDataSource3.SelectParameters["KadryId"].DefaultValue = App.KwitekKadryId;
#endif
#if IQOR && !CO && !PRON
        ...
        public bool OldWymiaryVisible
        {
            ...
            {
#if IQOR || CO
                //return true;   //20160725 wyłączam, dane są brane na podstawie Asseco
                return false;
#else
                return true;
#endif
        ...
        public void Prepare(string data, bool list)
        {
            ...
            {
                case moPanelPrac:
                    SqlDataSource1.SelectCommand = RepUrlop._GetSql(d1, data,   //<<<< to powinno się pobrac z Asseco
