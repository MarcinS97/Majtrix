<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntPracInfo.ascx.cs" Inherits="HRRcp.Controls.cntPracInfo" %>
    ...
    <tr>
        <td class="col1a">
            ...
            <table class="table0 cntRepPracInfo" >
                ...
                <tr>
                    <td class="col1"><span class="t1">Bieżący wymiar urlopu (dni):</span></td>
                    <td class="col2">
