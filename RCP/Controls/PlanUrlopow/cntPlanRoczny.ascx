<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntPlanRoczny.ascx.cs" Inherits="HRRcp.Controls.cntPlanRoczny" %>
...
<%@ Register src="cntPracInfo.ascx" tagname="cntPracInfo" tagprefix="uc1" %>
...
<table id="tbNavigator" class="okres_navigator tbPlanUrlopowRok_navigator" runat="server" visible="false" >
    <tr>
        ...
        <td class="colright">            
            ...
            <asp:Button ID="btBack" runat="server" Text="Powrót" Visible="false" CssClass="button75" OnClientClick="history.back();return false;" />
        </td>
    </tr>
</table>
...
select distinct 
	...
	ISNULL(convert(varchar, DATEADD(ms, -DATEPART(ms, P.Od), P.Od), 20), 'brak danych') as Text
from (select 1 X) X
