...
{
    public partial class Zastepstwa : System.Web.UI.UserControl
    {
        public int FMode;
        ...
        */
        ...
        private bool ValidateKier(int? k1, int? k2)
        {
            if (k1 != null && k2 != null)
            {
                ...
                else Tools.ShowError("Osoba zastępująca nie może być taka sama jak zastępowana.");
            }
            //else Tools.ShowMessage("Proszę wybrać osobę do zastępstwa.");
            else Tools.ShowError("Proszę wybrać osobę do zastępstwa.");
            return false;
        }
