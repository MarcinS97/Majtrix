<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntWniosekWolneZaNadg.ascx.cs" Inherits="HRRcp.Controls.Raporty.cntWniosekWolneZaNadgKier" %>
...
<div id="paWniosekWolneZaNadg" runat="server" class="cntWniosekWolneZaNadg">
    ...
    <asp:ListView ID="lvWniosek" runat="server" DataSourceID="SqlDataSource1" DataKeyNames="Id">
        <ItemTemplate>
            ...
            <span class="center">
                <span class="title">WNIOSEK O UDZIELENIE CZASU WOLNEGO W ZAMIAN ZA PRACĘ W GODZINACH NADLICZBOWYCH</span>
            </span>
            <br />
            <br />
            <br />
	        ...
	        <asp:Label ID="InfoLabel" CssClass="value" runat="server" Text='<%# Eval("Info") %>' />, 	        
	        w wymiarze <asp:Label ID="GodzinLabel" CssClass="value" runat="server" Text='<%# Eval("GodzinHMM") %>' /> godzin:minut.<br />
	        Czas wolny chciałbym wykorzystać <asp:Label ID="OdLabel" CssClass="value" runat="server" Text='<%# Eval("Od", "{0:d}") %>' />. 
            <br />
            <br />
            <br />
            <br />
