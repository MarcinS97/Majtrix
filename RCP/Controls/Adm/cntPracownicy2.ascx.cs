...
{
    public partial class cntPracownicy2: System.Web.UI.UserControl
    {
        ...
        */
        ...
        const int rightsCount = 16;     // max=21
        public static object[,] rights = new object[rightsCount, 2] {                     // nie używać '-' w opisach !!!
            ...
            ,{AppUser.rPrzesunieciaAdm,     "PX - Administracja ustawieniami przesunięć"}

            ,{AppUser.rWnioskiUrlopoweAcc,  "WU - Akceptowanie wniosków urlopowych"}
            ,{AppUser.rWnioskiUrlopoweSub,  "WS - Dostęp do wszystkich wniosków z podstuktury"}
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            Tools.PrepareSorting(lvPracownicy, 31, 50);
        ...
        */
        ...
        private void PrepareView()
        {
            ...
            string sort = String.IsNullOrEmpty(lvPracownicy.SortExpression) ? " order by Nazwisko,Imie" : null;
        ...
        protected void lvPracownicy_LayoutCreated(object sender, EventArgs e)
        {
          /*
            ...
            */
            ...
            //SqlDataSource1.SelectCommand = SqlDataSource1.SelectCommand.Replace("select", "select " + Tools.RightsToSelectSql("P.Rights"));

            SqlDataSource1.SelectCommand = "select " + Tools.RightsToSelectSql("P.Rights") + SqlDataSource1.SelectCommand.Substring(6);  //select
        }
