...
<div class="tbMailsFilter">
    <asp:DropDownList ID="ddlFilter" runat="server" DataSourceID="SqlDataSource2" DataTextField="Nazwa" DataValueField="Grupa" AutoPostBack="True">
    </asp:DropDownList>
    ...
    <EditItemTemplate>
        <tr class="eit">
            <td class="col1">
                ...
                <table>
                    <tr id="trOpis" runat="server" class="row0" visible="false">
                        ...
                        <td class="col2">
                            <asp:TextBox ID="tbOpis" class="opis textbox" runat="server" onclick="javascript:selectControl(null);" Text='<%# Bind("Opis") %>' />
                        </td>                        
                    </tr>
                    <tr id="trTyp" runat="server" class="row0" visible="false">
                        ...
                        <td class="col2">
                            <asp:TextBox ID="tbTyp" class="typ textbox" runat="server" onclick="javascript:selectControl(null);" Text='<%# Bind("Typ") %>' />
                        </td>                        
                    </tr>
                    ...
                    <tr class="row1">
                        ...
                        <td class="col2">
                            <asp:TextBox ID="TematTextBox" class="subject textbox" runat="server" Text='<%# Bind("Temat") %>' onclick="javascript:selectControl(this);" /><br />
                        </td>
                    </tr>
                    <tr class="row2">
                        <td class="col1">
                        ...
                        <td class="col2">
                            <asp:TextBox ID="TrescTextBox" class="body textbox" runat="server" Text='<%# Bind("Tresc") %>' onclick="javascript:selectControl(this);" Rows="15" TextMode="MultiLine" />
                        </td>
                    </tr>
            ...
            <td class="control">
                ...
                <br />
                <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="Usuń" Visible='<%# IsSuperuser %>' />
            </td>
        </tr>
    </EditItemTemplate>
    <InsertItemTemplate>
        <tr class="iit">
            ...
            <td class="control">
                ...
                <asp:Button ID="CancelButton" runat="server" CommandName="Clear" Text="Czyść" />
            </td>
        </tr>
    </InsertItemTemplate>
    <LayoutTemplate>
