...
// to nie ten plik w RCP3 !!!

namespace HRRcp.Controls
{
    public partial class cntPrzeznaczNadg : System.Web.UI.UserControl
    {
        ...
        */
            ...
            else
            {
                switch (lim)
                {
                    case Tools.limEdit:
                        ...
                        Tools.SelectItem(e.Item, "ddlNadg", drv["RodzajId"]);
                        break;
                }
            }
        }
        ...
        protected void lvPodzial_DataBound(object sender, EventArgs e)
        {
            ...
            Tools.SetControlVisible(lvPodzial, "thControl1", !ro);
            HtmlTableCell th = (HtmlTableCell)lvPodzial.FindControl("thLastCol");
            HtmlTableCell th1 = (HtmlTableCell)lvPodzial.FindControl("thLastCol1");
            if (th != null && th1 != null)
                if (ro)
                {
            ...
            Tools.SetText(lvPodzial, "lbNocneOdDo", App.GetNocneOdDo);
        }
        ...
        protected void ddlNadgInsert_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            TimeEdit teD = lvPodzial.InsertItem.FindControl("teNadgD") as TimeEdit;
            TimeEdit teN = lvPodzial.InsertItem.FindControl("teNadgN") as TimeEdit;
        ...
        */
        ...
        protected void ddlNadg_ValidateInsert(object source, ServerValidateEventArgs args)
        {
            args.IsValid = IsValid(lvPodzial.InsertItem, null);
        }

        protected void ddlNadg_ValidateEdit(object source, ServerValidateEventArgs args)
        {
        ...
        protected void lvPodzial_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            ...
            {
                case "Insert":
                    if (lvPodzial.EditIndex != -1) lvPodzial.EditIndex = -1;
                    break;
                case "Edit":
                    if (lvPodzial.InsertItemPosition != InsertItemPosition.None) lvPodzial.InsertItemPosition = InsertItemPosition.None;
                    break;
            }
        }
    }
