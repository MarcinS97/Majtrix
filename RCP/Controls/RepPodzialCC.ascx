<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RepPodzialCC.ascx.cs" Inherits="HRRcp.Controls.RepPodzialCC" %>
...
ISNULL(round(sum(S.vNocne * R.StawkaNocna),2),0) as [Suma kosztów:N0]
    ...
    SQL4="#tmpRepCC"
    SQL5="
,[Kwota 50:N0] [float] NULL,
[Kwota 100:N0] [float] NULL,
[Kwota Nocne:N0] [float] NULL,
[Koszt 50+100:N0] [float] NULL,
[Suma kosztów:N0] [float] NULL
    "    
    P3="and S.Typ < 10"
    SQL="
IF OBJECT_ID('tempdb..@SQL4') IS NOT NULL
	drop table @SQL4
CREATE TABLE [dbo].[@SQL4](
	[Od:-] [varchar](10) NULL,
	[Do:-] [varchar](10) NULL,
	[DoX:-] [varchar](10) NULL,
	[MiesRok:-] [nvarchar](231) NULL,
	[Okres rozliczeniowy|Reports/RepCCTygodnie @Od @Do @MiesRok|Podział tygodniowy] [nvarchar](231) NULL,
	[Od] [varchar](10) NULL,
	[Do] [varchar](10) NULL,
	[Raporty|Reports/RepCC @Od @Do 0 1|Podział na cc w okresie rozliczeniowym bez podzielonego 019] [varchar](6) NOT NULL,
	[|Reports/RepCC @Od @Do 1 1|Podział na cc w okresie rozliczeniowym z 019 podzielonym] [varchar](2) NOT NULL,
	
	[|Reports/RepCC3 @Od @Do 1 1|Podział na cc i klasyfikację w okresie rozliczeniowym z 019 podzielonym] [varchar](10) NOT NULL,
	
	[|Reports/RepCCKlasyfikacja @Od @Do 1 1|Podział wg klasyfikacji pracowników] [varchar](4) NOT NULL,
	[|Reports/RepCCDopelnienia @Od @Do * * 0|Pracownicy mający dopełnienia z zaokrągleń] [varchar](3) NOT NULL,
	[|Reports/RepCCNadminuty @Od @Do * * *|Pracownicy mający nadminuty] [varchar](6) NOT NULL,
	[|Reports/RepCCSplity2 @Od @Do|Podział ludzi na cc w okresie rozliczeniowym] [varchar](6) NOT NULL,
	[|Reports/RepCCPracownicyCC @Od @Do 0 1 * *|Podział czasu pracy ludzi na cc w okresie rozliczeniowym bez podzielonego 019] [varchar](8) NOT NULL,
	[|Reports/RepCCPracownicyCC @Od @Do 1 1 * *|Podział czasu pracy ludzi na cc w okresie rozliczeniowym] [varchar](4) NOT NULL,
	[Czas Zm:N0|Reports/RepCCPracownicy @Od @Do * * 0 * 1 1|Pracownicy] [float] NOT NULL,
	[Nadg 50:N0|Reports/RepCCPracownicy @Od @Do * * 50 * 1 1|Pracownicy z nadgodzinami 50] [float] NOT NULL,
	[Nadg 100:N0|Reports/RepCCPracownicy @Od @Do * * 100 * 1 1|Pracownicy z nadgodzinami 100] [float] NOT NULL,
	[Nadg 50+100:N0|Reports/RepCCPracownicy @Od @Do * * 150 * 1 1|Pracownicy z nadgodzinami (50+100)] [float] NOT NULL,
	[Nocne:N0|Reports/RepCCPracownicy @Od @Do * * 2 * 1 1|Pracownicy pracujący w czasie nocnym] [float] NOT NULL
	@SQL5
) ON [PRIMARY]
...
declare @od datetime
declare @do datetime
--set @od = '20121121' -- pierwsze dane mpk
set @do = dbo.bom(GETDATE())
set @od = DATEADD(YEAR, -1, @do)
--set @od = DATEADD(M, -1, @do)
...
'ccklas'   as [|Reports/RepCC3 @Od @Do 1 1|Podział na cc w okresie rozliczeniowym z 019 podzielonym],
...
set @od = ISNULL((select top 1 DataOd from OkresyRozl where DataOd &gt; @od order by DataOd), DATEADD(M, 1, @od))
