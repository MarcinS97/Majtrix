...
namespace HRRcp
{
    public partial class RapAbsencje : System.Web.UI.Page
    {
        ...
        */
        ...
        public void DownloadPDF()
        {
            ...
            */
            ...
            if (Controls.Count > 0)
            {
                ...
                */
                //GetFilename(Controls[0])
                string filename = "Absencja";
                if (PDF.Download(Controls, Server, Response, Request, db.RemovePL(Tools.PrepareFilename(filename))) != 0)
        ...
        //-------------------
        /*
        private bool DownloadPDFAbsencja()
        {
            PDF PDF = new PDF();
            PDF.CssClasses[0] = "../styles/master3.css";
            //PDF.Options = "-O landscape";
            if (PDF.Download(PDF.Prepare(sb.ToString(), Request), Server, Response, Request, "Absencje") == 0)
                return true;
            else
                return false;
        }
        ...
        protected void dsAbsencjePrac_Selected(object sender, SqlDataSourceStatusEventArgs e)
        {
        ...
        protected void rpPracownicy_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
