...
{
    public partial class cntRequestsAdmin2 : System.Web.UI.UserControl
    {
        ...
        public void Prepare(String ObserverId, String Date2)
        {
        ...
        public String GetError(int err)
        {
            switch (err)
            {
                case 0: 
                    return String.Empty;
                case 1:
                    return "Wymaga akcji administracyjnej (TL)";
                case 2:
                    return "Wymaga akcji administracyjnej (KIER)";
                case 3:
                    return "Wymaga akcji administracyjnej (TL, KIER)";
            }
            return String.Empty;
        }
        ...
        protected void ShowRequest(object sender, EventArgs e)
        {
            ...
            ShowRequest(RequestId, ObserverId, Status, (GetMode() == moMine && (Status == "0" || (Status == "1" && Upr == uprKier))) || (GetMode() == moToAcc), Type == "1", Genre == "1");
        }
        ...
        public void ShowRequest(String RequestId, String ObserverId, String Status, Boolean Editable, Boolean Custom, Boolean Genre)
        {
            ...
            Request.Prepare(RequestId, ObserverId, GetMode(), Upr, Editable, Custom, Genre && !Custom);
        ...
        public String GetUpr()
        {
            ...
            if (/*App.User.HasRight(AppUser.rScorecardsPrez))*/GetRight(ObserverId, "59")) return "2";
        ...
        public String Date2
        {
            get { return hidDate2.Value; }
            set { hidDate2.Value = value; }
        }
