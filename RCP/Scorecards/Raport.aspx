<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Scorecards/Report.Master" AutoEventWireup="true" CodeBehind="Raport.aspx.cs" Inherits="HRRcp.Scorecards.Raport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="headReport" runat="server">
    <script type="text/javascript">
        //if ($(".title0").text() == "Pracownicy 2") {
            $(document).on("ready", function() {

                //$("td").each(function() {
                $("table.GridView1 td").each(function() {
                    $(this).html($(this).html().replace("_hap", "<img src='images/Happy64px.png' style='border-width:0px; width: 16px;'>"));
                    $(this).html($(this).html().replace("_sad", "<img src='images/Sad64px.png' style='border-width:0px; width: 16px;'>"));
                    $(this).html($(this).html().replace("_spook", "<img src='images/Skeleton64px.png' style='border-width:0px; width: 16px;'>"));
                });
