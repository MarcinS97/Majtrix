<%@ Page Title="" Language="C#" MasterPageFile="~/Scorecards/Scorecards.Master" AutoEventWireup="true" CodeBehind="Start.aspx.cs" Inherits="HRRcp.Scorecards.Start" %>
...
<%@ Register Src="~/Scorecards/Controls/Spreadsheets/cntSpreadsheetsList.ascx" TagPrefix="leet" TagName="SpreadsheetsList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="page960 startform">
        ...
        <div id="divWnioski" runat="server" class="border fiszka" visible="false">
            <uc1:PageTitle ID="PageTitle3" runat="server"
                Ico="../images/captions/layout_edit.png"
                Title="Wnioski do akceptacji" 
            />
                        <leet:Requests ID="cntWnioskiPremioweToAcc" runat="server" Mode="1" StartForm="true" />

        </div>
        
        
        
        <div id="divArkusze" runat="server" class="border fiszka" visible="false">
            <uc1:PageTitle ID="PageTitle4" runat="server"
                Ico="../images/captions/layout_edit.png"
                Title="Arkusze do akceptacji" 
            />
                        <leet:SpreadsheetsList ID="cntSprList" runat="server" />
