<%@ Page Title="" Language="C#" MasterPageFile="~/Scorecards/Scorecards.Master" AutoEventWireup="true" CodeBehind="WnioskiAdmin.aspx.cs" Inherits="HRRcp.Scorecards.WnioskiAdmin" %>
<%@ Register src="~/Controls/PageTitle.ascx" tagname="PageTitle" tagprefix="uc1" %>
<%@ Register src="~/Scorecards/Controls/Requests/cntWnioskiMenuAdmin.ascx" tagname="cntWnioskiMenu" tagprefix="uc2" %>
