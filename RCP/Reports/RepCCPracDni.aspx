<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="RepCCPracDni.aspx.cs" Inherits="HRRcp.Reports.RepCCPracDni" %>
...
group by S.Data, S.StawkaGodz, S.StawkaNocna
, S.TypOpis
