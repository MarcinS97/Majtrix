<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="RepCCSplity2.aspx.cs" Inherits="HRRcp.Reports.RepCCSplity2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderReport" runat="server">    
    <div class="report_page">
        <uc1:cntReport ID="cntReportTitle" runat="server" Browser="true"
            Title="Splity obowi¹zuj¹ce w okresie: @p1 - @p2"
            CssClass=""
        />
        ...
        <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource1">
            <ItemTemplate>
               <uc1:cntReport ID="cntReport2" runat="server" Browser="true"
                    HeaderVisible="false"
                    CssClass=""
                    SQL1='<%# DataBinder.Eval(Container.DataItem, "GrSplitu") %>'
                    SQL="
declare 
    @colsH nvarchar(max), 
    @colsD nvarchar(max), 
...
SELECT grCC + '' - '' + grNazwa as [CC (Grupa)], ' + @colsD +
'FROM
(
...
exec sp_executesql @stmt" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM [CC] WHERE ([Grupa] = @Grupa) ORDER BY [CC]">
            <SelectParameters>
