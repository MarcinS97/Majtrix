<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntCertyfikatAdd.ascx.cs" Inherits="HRRcp.SzkoleniaBHP.Controls.cntCertyfikatAdd" %>
<%@ Register src="cntCertyfikatHeader.ascx" tagname="cntCertyfikatHeader" tagprefix="uc1" %>
...
--%>
        ...
        <LayoutTemplate>
            <table runat="server" class="narrow tbCertyfikaty">
                <tr runat="server">
                    <td runat="server">
                        <table ID="itemPlaceholderContainer" runat="server" border="0" style="" name="report">
