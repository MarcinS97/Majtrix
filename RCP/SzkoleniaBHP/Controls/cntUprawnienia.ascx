<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntUprawnienia.ascx.cs" Inherits="HRRcp.SzkoleniaBHP.Controls.cntUprawnienia" %>
...
<%@ Register src="cntCertyfikat3.ascx" tagname="cntCertyfikat" tagprefix="uc6" %>
...
<%--
<%@ Register src="cntCertyfikatySpaw4.ascx" tagname="cntCertyfikatSpaw" tagprefix="uc6" %>
                ...
                <tr>
                    <td class="left" >
                        <span class="caption4">
                            ...
                            <asp:Label ID="lbTitle" CssClass="title" runat="server" Text="Szkolenia BHP"></asp:Label>                                                    
                        </span>
                    </td>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="col2b" >
                                    ...
                                    <asp:TextBox ID="tbMonit" CssClass="textbox" runat="server" Width="30" 
                                        MaxLength="3" AutoPostBack="true" ontextchanged="tbMonit_TextChanged" ></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="col2">
                                    <asp:DropDownList ID="ddlKier" runat="server" AutoPostBack="True" 
                                        DataSourceID="SqlDataSourceKier" DataTextField="Value" DataValueField="Id" 
                                        OnSelectedIndexChanged="ddlKier_SelectedIndexChanged" 
                                        OnDataBound="ddlKier_DataBound">
                                    </asp:DropDownList>
                                </td>
                                <td class="col3">
                                    <asp:CheckBox ID="cbShowSub" runat="server" CssClass="check" 
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="col2">
                                    <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="True" DataSourceID="SqlDataSourceStatus" DataTextField="Value" DataValueField="Id" 
                                        onselectedindexchanged="ddlStatus_SelectedIndexChanged" >
                                    </asp:DropDownList>
                                </td>
                                <td class="col3">
                                    <asp:CheckBox ID="cbWithOnly" runat="server" CssClass="check" 
                                        Text="Pokaż tylko posiadających uprawnienia" AutoPostBack="true" 
                                        oncheckedchanged="cbWithOnly_CheckedChanged"/>
                                    <asp:CheckBox ID="cbPassSpaw" runat="server" CssClass="check" 
                                        Text="Pokaż tylko spawaczy" AutoPostBack="true" Visible="false" 
                                        oncheckedchanged="cbPassSpaw_CheckedChanged"/>
                                </td>
                            </tr>
                            <%-- cc --%>
                            <tr>
                                ...
                                <td colspan="2" class="col2">
                                    <asp:DropDownList ID="ddlCC" runat="server" AutoPostBack="True" 
                                        DataSourceID="SqlDataSourceCC" DataTextField="Value" DataValueField="Id" 
...
union all            
select 'all' as Id, 'Wszyscy' as Value, 60 as Sort
                            ">
                        </asp:SqlDataSource>
...
--%>
                        ...
                        <asp:Button ID="btAdmin" CssClass="button100" Text="Administracja" runat="server" PostBackUrl="~/SzkoleniaBHP/Admin.aspx" />
...
--%>
                                <asp:Label ID="Label3" Text="Symbol" runat="server" />
                            <asp:Repeater ID="rpHeader1" runat="server" OnItemCommand="rpUprawnienia_ItemCommand">
                                <ItemTemplate>
                                    </th><th class='data1 xvert<%# GetHeaderClass() %>'>
...
<%--
                                            <asp:Label ID="lbVal" runat="server" Text='<%# Eval("Nazwa") %>' />    
--%>
                                        </div>
                                </ItemTemplate>
                            </asp:Repeater>                                
                            </th>
                            <th rowspan="2" class="suma vert" ><div><span>
                                <asp:LinkButton ID="LinkButton3" runat="server" CommandName="Sort" CommandArgument="Aktualne" Text="Aktualne" ></asp:LinkButton>            
                            </span></div></th>
                            <th rowspan="2" class="suma vert" ><div><span>                            
                                <asp:LinkButton ID="LinkButton4" runat="server" CommandName="Sort" CommandArgument="Wygasajace" Text="Wygasające" ></asp:LinkButton>            
                            </span></div></th>
                            <th rowspan="2" class="suma vert" ><div><span>
...
--%>
                            <asp:Repeater ID="rpHeader4" runat="server" OnItemCommand="rpUprawnienia_ItemCommand">
                                <ItemTemplate>
                                </th><th class='uprtitle<%# GetHeaderClass() %>'>
<%--
                                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Sort" CommandArgument='<%# "[" + Eval("Id") + "]" %>' Text='<%# "[" + Eval("Id") + "]" %>' ></asp:LinkButton>            
--%>
                                    <asp:LinkButton ID="LinkButton10" runat="server" CommandName="Sort" CommandArgument='<%# "[" + Eval("Id") + "]" %>' Text='<%# Eval("Symbol") %>' ></asp:LinkButton>            
                                </ItemTemplate>
                            </asp:Repeater>
                            </th>
<%--
...
--%>                            
                        ...
                        <%----- sumy -----%>
                        <tr class="sumy it">
                            <td class="suma_title divR" colspan="2" id="tdSum1" runat="server"><asp:Label ID="Label4" Text="Aktualne" runat="server" />
                            <asp:Repeater ID="rpSumA" runat="server" OnItemCommand="rpUprawnienia_ItemCommand">
                                <ItemTemplate>
                                    </td><td class='suma<%# GetSumClass() %>'>
                        ...
                        <tr class="sumy it">
                            <td class="suma_title divR" colspan="2" id="tdSum2" runat="server"><asp:Label ID="Label5" Text="Wygasające" runat="server" />
                        ...
                        <tr class="sumy it">
                            <td class="suma_title divR" colspan="2" id="tdSum3" runat="server"><asp:Label ID="Label6" Text="Przeterminowane" runat="server" />
                        ...
                        <tr class="sumy it" id="trSumB" runat="server" visible="false">
                            <td class="suma_title divR" colspan="2" id="tdSum4" runat="server"><asp:Label ID="Label8" Text="Brak" runat="server" />
...
<div id="divZoom" style="display:none;" class="modalPopup">
    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
        <ContentTemplate>
            ...
            <uc6:cntCertyfikatAdd ID="cntCertyfikat" runat="server" Mode="0"  Visible="false" />                        
            <uc6:cntCertyfikatAdd ID="cntCertyfikatAdd" runat="server" Mode="1" Visible="false" />                        
            <%--
...
select 
    ...
    --:CUT
	ISNULL(CONVERT(varchar(10), ISNULL(C2.DataWaznosci, C.DataWaznosci), 20), ''x'') + ''|'' +		
	--ISNULL(CONVERT(varchar, ISNULL(C2.Id, C.Id)), ''x'') + ''|'' + 
	ISNULL(CONVERT(varchar, C.Id), ''x'') + ''|'' + 

	case 
		when ISNULL(C2.Id, C.Id) is not null and ISNULL(C2.DataWaznosci, C.DataWaznosci) is null then ''bezterm''
	...
	case when C.Id is null then '' brak control'' else '''' end + ''|'' + 
...
outer apply (select top 1 * from Certyfikaty 
            ...
            and DataZdobyciaUprawnien &gt;= DATEADD(D,-7,P.DataZatr)
...
and (@withonly = 0 or P.Id in (select distinct U.IdPracownika from VCertyfikatyUprawnienie U where U.Aktualny = 1 and (@typ2 = -99 or not U.Typ & @typ2 = 0) and (@kwal2 = -99 or U.KwalifikacjeId = @kwal2)))
...
outer apply (
    ...
    */
	...
	ISNULL(@ucount2 - count(*), 0) [Brak]  
	from VCertyfikatyUprawnienie3 where IdPracownika = PV.IdPracownika and Aktualny = 1 and IdUprawnienia in (' + @uprList + ')
	*/
    ...
    ISNULL(@ucount2 - count(*), 0) [Brak]  
    from (
    select distinct Id2, DataWaznosci2 
    from VCertyfikatyUprawnienie3 where IdPracownika = PV.IdPracownika and Aktualny = 1 and IdUprawnienia in (' + @uprList + ')
	) D
) S
...
where 
    ...
    @filter2 = 1 and PV.IdPracownika in (
        select C2.IdPracownika from VCertyfikatyUprawnienie2 C2 where (@typ2 = -99 or not C2.Typ & @typ2 = 0) and (@kwal2 = -99 or C2.KwalifikacjeId = @kwal2) 
    ...
    */
    @filter2 = 3 and PV.IdPracownika in (
        select C2.IdPracownika from VCertyfikatyUprawnienie3 C2 where (@typ2 = -99 or not C2.Typ & @typ2 = 0) and (@kwal2 = -99 or C2.KwalifikacjeId = @kwal2) 
            and C2.Aktualny = 1 and (C2.DataWaznosci2 &lt; @data2)         
    ) or
    @filter2 = -1 and PV.IdPracownika not in (
        select C1.IdPracownika from VCertyfikatyUprawnienie C1 where (@typ2 = -99 or not C1.Typ & @typ2 = 0) and (@kwal2 = -99 or C1.KwalifikacjeId = @kwal2) 
		    and C1.Aktualny = 1
    )
...
" 
    ...
    <SelectParameters>
        ...
        <asp:ControlParameter ControlID="ddlCC" Name="cc" PropertyName="SelectedValue" Type="String"/>
...
3 - testy (nieudane)
	...
	from VCertyfikatyUprawnienie2 where IdPracownika = PV.IdPracownika and Aktualny = 1 and IdUprawnienia in (' + @uprList + ')
	) D
	*/
--%>
...
select 
    ...
    * 
from Uprawnienia 
where (@typ = -99 or not Typ & @typ = 0) and (@kwal = -99 or KwalifikacjeId = @kwal) and Grupa = 0 and Aktywne = 1
...
<asp:SqlDataSource ID="SqlDataSourceSum" runat="server" ConnectionString="<%$ ConnectionStrings:HRConnectionString %>" CancelSelectOnNullParameter="false"
    SelectCommand="
...
and (@cc = -99 or R.Id in (select IdPrzypisania from SplityWspP where IdCC = @cc))
group by U.Id, U.Kolejnosc, U.Poziom, U.PoziomEN, U.symbol, U.Nazwa, u.NazwaEN, U.KwalifikacjeId, U.PoziomId, U.PoziomPoziom
order by 
	U.Kolejnosc, 
...
<asp:SqlDataSource ID="SqlDataSourceTotal" runat="server" ConnectionString="<%$ ConnectionStrings:HRConnectionString %>" CancelSelectOnNullParameter="false"
    SelectCommand="
--declare @monit int = 30
--declare @data datetime = GETDATE()
--declare @status2 varchar(10) = 'p'
