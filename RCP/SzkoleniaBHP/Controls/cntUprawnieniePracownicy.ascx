<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntUprawnieniePracownicy.ascx.cs" Inherits="HRRcp.SzkoleniaBHP.Controls.cntUprawnieniePracownicy" %>
