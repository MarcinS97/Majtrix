...
namespace HRRcp.MatrycaSzkolen.App_Code
{
    public class MSMailing
    {
        ...
        public static bool EventMS(string maTyp, string id, string akcja, string[] userIds)
        {
            bool ok = true;
            foreach (String userId in userIds)
            {
                ok &= EventMS(maTyp, id, akcja, userId);
            }
            return ok;
        }
        ...
        public static bool EventMS(string maTyp, string id, string akcja, string userId/*, PDF att, string html*/) // id = idZamowienia lub idPozycji
        {
            try
            {
                String Filename = "";
            ...
            {
                Log.Error(Log.t2SENDMAIL, "EventMS", ex.Message);
                return false;
            }
        }
