<%@ Page Title="" ValidateRequest="false" Language="C#" MasterPageFile="~/MatrycaSzkolen/MS.Master" AutoEventWireup="true" CodeBehind="SzkoleniaAdmin.aspx.cs" Inherits="HRRcp.MatrycaSzkolen.SzkoleniaAdmin" %>
<%@ Register src="~/Controls/PageTitle.ascx" tagname="PageTitle" tagprefix="uc1" %>
<%@ Register src="~/MatrycaSzkolen/Controls/Uprawnienia/cntAdmUprawnienia.ascx" tagname="cntAdmUprawnienia" tagprefix="uc5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div id="pgAdministracja2" class="xmwrapper">
        <div class="xmcontent">
<%--            <table class="caption">
                <tr>
                    <td class="left" >
...
--%>
            <uc1:PageTitle ID="pgTitle" runat="server" Title="Uprawnienia - Administracja" SubText1="Administracja uprawnieniami" />
