<%@ Page Title="" Language="C#" MasterPageFile="~/MatrycaSzkolen/MS.Master" AutoEventWireup="true" CodeBehind="ListaZgloszen.aspx.cs" Inherits="HRRcp.MatrycaSzkolen.ListaZgloszen" %>

<%@ Register src="~/Controls/PageTitle.ascx" tagname="PageTitle" tagprefix="uc2" %>
<%@ Register Src="~/MatrycaSzkolen/Controls/cntListaZgloszen.ascx" TagPrefix="cc" TagName="cntZgloszenie" %>
