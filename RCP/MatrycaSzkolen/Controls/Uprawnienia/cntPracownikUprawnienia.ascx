<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntPracownikUprawnienia.ascx.cs" Inherits="HRRcp.MatrycaSzkolen.Controls.Uprawnienia.cntPracownikUprawnienia" %>
