...
//#elif MS || DBW
            ...
            switch (typ)
            {
                ...
                case Types.MS.Badania:
                    all = App.User.HasRight(AppUser.rMSHR) || adm || App.User.HasRight(AppUser.rMSBHP) || App.User.HasRight(AppUser.rMSBadaniaPodglad);
                ...
                case Types.MS.SzkoleniaBHP:
                    all = App.User.HasRight(AppUser.rMSBHP) || adm;
