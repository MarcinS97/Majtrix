<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntSplityWsp.ascx.cs" Inherits="HRRcp.MatrycaSzkolen.Controls.Przypisania.cntSplityWsp" %>
    ...
    <ItemTemplate>
        <tr class="it">
            ...
            <td id="tdWsp" runat="server" class='<%# "num" + IsLastColClass %>'>
                ...
                <asp:TextBox ID="WspTextBox" runat="server" CssClass="sumwsp textbox" MaxLength="6" Text='<%# Eval("Wsp") %>' Visible='<%# !IsReadOnly %>'/>
