<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntSplity.ascx.cs" Inherits="HRRcp.MatrycaSzkolen.Controls.Przypisania.cntSplity" %>
<%@ Register src="~/Controls/SplitWsp.ascx" tagname="SplitWsp" tagprefix="uc3" %>
