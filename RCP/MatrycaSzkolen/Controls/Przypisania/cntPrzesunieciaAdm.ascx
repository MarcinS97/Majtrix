<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntPrzesunieciaAdm.ascx.cs" Inherits="HRRcp.MatrycaSzkolen.Controls.Przypisania.cntPrzesunieciaAdm" %>
        ...
        <td class="LeftMenuContent">
            <asp:MultiView ID="mvPrzesuniecia" runat="server" ActiveViewIndex="0">
                <asp:View ID="vPrzesun" runat="server" onactivate="vPrzesun_Activate">
                    <uc1:cntPrzypisaniaEdit ID="cntPrzypisaniaEdit" Mode="ADM" runat="server" />
                </asp:View>

                <asp:View ID="vDoAkceptacji" runat="server">
                    <uc2:cntPrzypisania ID="cntPrzypisania2" Status="0" Mode="1" Filter="2" runat="server" />
                </asp:View>

                <asp:View ID="vZaakceptowane" runat="server">
                    <uc2:cntPrzypisania ID="cntPrzypisania3" Status="1" Mode="1" Filter="1" runat="server" />
                </asp:View>

                <asp:View ID="vOdrzucone" runat="server">
                    <uc2:cntPrzypisania ID="cntPrzypisania4" Status="2" Mode="1" Filter="2" runat="server" />
                </asp:View>

                <asp:View ID="vWszystkie" runat="server">
                    <uc2:cntPrzypisania ID="cntPrzypisania1" Status="99" Mode="1" Filter="1" runat="server" />
                </asp:View>
