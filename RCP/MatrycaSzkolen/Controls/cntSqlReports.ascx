<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntSqlReports.ascx.cs" Inherits="HRRcp.MatrycaSzkolen.Controls.cntSqlReports" %>
...
<div id="paSqlReports" runat="server" class="cntSqlReports">
    ...
    <ajaxToolkit:Accordion ID="acordionMenu" runat="server" DataSourceID="SqlDataSource3"
        ...
        OnPreRender="acordionMenu_PreRender" SuppressHeaderPostbacks="true"  RequireOpenedPane="true" Visible="false" >    
        <HeaderTemplate>
            <%--
        ...
        <ContentTemplate>
            ...
            <asp:ListView ID="lvPodKategorie" runat="server" DataKeyNames="Id"  
                ...
                <ItemTemplate>
                    <tr id="Tr1" class="it">
                        <td>
                            <asp:LinkButton ID="lbtPodKategoria" runat="server"  CommandName="Select" CommandArgument='<%# Eval("Command") %>' >
                                <i class="fa fa-cog"></i>
                                <%# Eval("MenuText") %>
                            </asp:LinkButton>
                        </td>
...
<asp:SqlDataSource ID="dsData" runat="server" ConnectionString="<%$ ConnectionStrings:HRConnectionString %>"
    SelectCommand="
declare @Grupa nvarchar(MAX) = {0}
declare @lng nvarchar = 'PL'
declare @Rights nvarchar = {2}
declare @Mode int = {1}
