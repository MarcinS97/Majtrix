<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntUprawnieniaSzkol.ascx.cs" Inherits="HRRcp.MatrycaSzkolen.Controls.Adm.cntUprawnieniaSzkol" %>
...
<div id="ctSpreadsheetsTasks" runat="server" class="cntSpreadsheetsTasks cntUprawnieniaSzkol">
    <div class="left">
        <asp:Label ID="Label1" runat="server" CssClass="title" Text="Trenerzy" />
        <hr />
...
">
    ...
    <div class="middle">
        <asp:Label ID="Label2" runat="server" CssClass="title" Text="Trenerzy - Uprawnienia" />
        <hr />
        ...
        <div id="ctSpreadsheetsTasksList" runat="server" class="cntSpreadsheetsTasksList">
            ...
            <asp:Label ID="lblMustSelect" runat="server" Text="Wybierz pracownika" />
            <asp:ListView ID="lvPracSzkolenia" runat="server" DataSourceID="dsPracSzkolenia" DataKeyNames="Id"
                ...
                <EmptyDataTemplate>
                    <table id="Table1" runat="server" class="table0">
                        <tr class="edt">
                            <td>
                                <asp:Label ID="lbNoData" runat="server" Text="Trener nie posiada uprawnień do szkoleń" CssClass="label" /><br />
                                <br />
                                <%--<asp:Button ID="btNewRecord" CssClass="button margin0" runat="server" CommandName="NewRecord" Text="Dodaj" />--%>
                            </td>
                        </tr>
...
"
                ...
                UpdateCommand="update msMapaUprawnien SET DataOd = @DataOd, DataDo = @DataDo WHERE [Id] = @Id">
                <SelectParameters>
...
<asp:SqlDataSource ID="dsRemove" runat="server" ConnectionString="<%$ ConnectionStrings:HRConnectionString %>"
    SelectCommand="
delete from msMapaUprawnien where Id = {0}
" />

<asp:SqlDataSource ID="dsInsert" runat="server" ConnectionString="<%$ ConnectionStrings:HRConnectionString %>"
    SelectCommand="
insert into msMapaUprawnien (IdUprawnienia, IdPracownika, DataOd) values ({0}, {1}, {2})
" />
