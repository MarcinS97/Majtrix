<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdmInfoControl.ascx.cs" Inherits="HRRcp.MatrycaSzkolen.Controls.Adm.AdmInfoControl" %>
    ...
    <ItemTemplate>
        <tr class="it" style="">
            <td class="col1">
                ...
                <br />
                <asp:Panel ID="paTekst1" class="textbox readonly" runat="server" ScrollBars="Auto" Height="100px" runat="server">
            ...
            <td id="control" runat="server" class="control">
                ...
                <asp:Button ID="TestButton" runat="server" CommandName="Test" CommandArgument='<%# Eval("Typ") %>' Text="Testuj" />
            </td>
        </tr>
    </ItemTemplate>
    <EmptyDataTemplate>
