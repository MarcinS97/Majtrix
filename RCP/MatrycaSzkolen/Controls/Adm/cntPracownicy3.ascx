<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntPracownicy3.ascx.cs" Inherits="HRRcp.MatrycaSzkolen.Controls.Adm.cntPracownicy3" %>
...
<%@ Register src="~/Controls/Adm/cntKartyRcpPopup.ascx" tagname="cntKartyRcpPopup" tagprefix="uc2" %>
<%@ Register src="~/Controls/Adm/cntAlgorytmyPopup.ascx" tagname="cntAlgorytmyPopup" tagprefix="uc2" %>
<%@ Register src="~/Controls/Adm/cntStanowiskaPopup.ascx" tagname="cntStanowiskaPopup" tagprefix="uc2" %>
...
<div id="paFilter" runat="server" class="paFilter tbPracownicy2_filter" visible="true">
    <div class="left">
        ...
        <asp:TextBox ID="tbSearch" CssClass="search textbox form-control input-sm" runat="server" ></asp:TextBox>
        <asp:Button ID="btClear" runat="server" CssClass="button75 btn btn-sm btn-default" Text="Czyść" />
    </div>
...
<div class="tbPracownicy2_topmenu">
    <asp:Menu ID="tabFilter" runat="server" Orientation="Horizontal" 
        ...
        <Items>             <%--to jest formatka administracyjna dlatego filtry mogą tak wyglądać--%>
            ...
            <asp:MenuItem Text="DBW" Value="Status >= 0 and Klasyfikacja = 'DBW'" ></asp:MenuItem>
            <asp:MenuItem Text="Osadzeni" Value="Status >= 0 and Klasyfikacja = 'ARESZT'" ></asp:MenuItem>
            <asp:MenuItem Text="APT" Value="Status >= 0 and Klasyfikacja not in ('DBW','ARESZT')" ></asp:MenuItem>
...
<asp:ListView ID="lvPracownicy" runat="server" DataSourceID="SqlDataSource1" 
    ...
    <ItemTemplate>
        <tr class="it" id="trLine" runat="server">
            ...
            <td class="strefa" id="x_tdStrefa" runat="server" visible="false" >
            ...
            <td class="kierownik" id="tdKierownik" runat="server" >
                ...
                <div id="paClass1" runat="server" visible="false">
                <span class="line2" id="tdKierownikLine2" runat="server" visible="false">
            ...
            <td class="dzial">
                <asp:Label ID="Label4" runat="server" Text='<%# Eval("Grupa") %>' /><br />
            </td>
            <td class="dzial">
                <asp:Label ID="Label5" runat="server" Text='<%# Eval("Klasyfikacja") %>' />
            </td>
    ...
    <EditItemTemplate>
        <tr class="eit">
            <td colspan="<%= Int32.Parse(GetEditColSpan()) + 1 %>" class="col1">
                <table class="edit">
                    <tr>
                        <td class="coled1">
                            <div class="title">
...
--%>
                            ...
                            <div id="paPass" runat="server" >
                                ...
                                <div class="kwitek">
                                    <asp:Button ID="btKwitekPassGen" runat="server" class="button btn btn-sm btn-default" Text="Generuj losowe" CommandName="passgen" /><br />
                                    <asp:Button ID="btKwitekPassSet" runat="server" class="button btn btn-sm btn-default" Text="Ustaw hasło do kwitka płacowego" CommandName="passset" CommandArgument='<%# Eval("Id") %>' /><br />
                                  <%--  <br />--%>
                                    <asp:Button ID="btKwitekPassReset" runat="server" class="button btn btn-sm btn-default" Text="Resetuj hasło do kwitka płacowego" CommandName="passreset" CommandArgument='<%# Eval("Id") %>' /><br />
                                </div>
                            </div>
                            </div>
                        </td>
                        <td class="coled2">
                            ...
                            <div runat="server" id="div8001" visible="false">
                            ...
                            <div id="paCommodity" runat="server" visible="false">
                            ...
                            <div id="paArea" runat="server" visible="false">
                            ...
                            <div id="paMSOmit" runat="server" visible="false">
            ...
            <td class="control" >
                <asp:Button ID="UpdateButton" runat="server" CommandName="Update" Text="Zapisz" ValidationGroup="vge" CssClass="btn-success" /><br />
                <asp:Button ID="CancelButton" runat="server" CommandName="Cancel" Text="Anuluj" /><br /><br />
                <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="Usuń" CssClass="btn-danger" />
            </td>
        </tr>
    </EditItemTemplate>
...
<%--            <td colspan="<%= GetEditColSpan() %>" class="col1">--%>
                ...
                <table class="edit">
                    <tr>
                        ...
                        <td class="coled2">
                            ...
                            <br />
                            <div id="div8002" runat="server" visible="false">
                            <span class="label">Grade:</span>
                            ...
                            <div runat="server" id="paMSOmit" visible="false">
                            <span class="label">CC:</span>                
            ...
            <td class="control" >
                <asp:Button ID="InsertButton" runat="server" CommandName="Insert" Text="Zapisz" ValidationGroup="vgi"/><br />
    ...
    <LayoutTemplate>
        <table class="xhoverline cntPracownicy2" runat="server">
                ...
                <td id="Td1" colspan="2" runat="server">
                    <table ID="itemPlaceholderContainer" class="tbPracownicy2" runat="server" border="0" style="">
                        <tr id="Tr2" runat="server" style="">
                            ...
                            <th id="x_thStrefa" rowspan="2" runat="server" visible="false">
                            ...
                            <th id="th3" rowspan="2" runat="server">
                                <asp:LinkButton ID="LinkButton118" runat="server" CommandName="Sort" CommandArgument="Grupa"        Text="Rodzaj stanowiska" ToolTip="Sortuj"/>
                            </th>
                            <th id="th4" rowspan="2" runat="server">
                                <asp:LinkButton ID="LinkButton119" runat="server" CommandName="Sort" CommandArgument="Klasyfikacja"   Text="Firma" ToolTip="Sortuj"/>
                            </th>
                            ...
                            <th id="Th11" class="control" rowspan="2" runat="server">
                                <asp:Button ID="btNewRecord" runat="server" CommandName="NewRecord" Text="Dodaj" ToolTip="Dodaj nowy rekord"  CssClass="btn btn-sm btn-success" />
                            </th>
                        </tr>
                        <tr class="bottom">
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HRConnectionString %>" 
    ...
    case PS.Rodzaj when 'P' then 'Produkcja' when 'A' then 'Administracja' end as RodzajPracownika, 
...
UPDATE [Pracownicy] SET [Login] = @Login, [Imie] = @Imie, [Nazwisko] = @Nazwisko, 
                        ...
                        [Admin] = @Admin, [Raporty] = @Raporty, [Kierownik] = @Kierownik, [KadryId] = @KadryId, [KadryId2] = @KadryId2, [Status] = @Status, [Rights] = @Rights, DataZatr = @DataZatr, DataZwol = @DataZwol, OkresProbnyDo = @OkresProbnyDo
                        WHERE [Id] = @Id
...
if @IdPrzypisania is not null begin   
    ...
    set @IdPrzypisaniaNew = (select @@Identity)
end
...
INSERT INTO [Pracownicy] ([Login], [Imie], [Nazwisko], 
                        --[Opis], 
                        [Email], [Mailing], [IdDzialu], [IdStanowiska], [IdKierownika], [Admin], [Raporty], [Kierownik], [KadryId], KadryId2, [RcpId], [Status], [RcpStrefaId], [RcpAlgorytm], [CCInfo], [Rights], [IdLinii], [GrSplitu], DataZatr, DataZwol, EtatL, EtatM, Stawka, OkresProbnyDo) VALUES 
                         (@Login, @Imie, @Nazwisko, 
                         --@Opis, 
                         @Email, @Mailing, @IdDzialu, @IdStanowiska, @IdKierownika, @Admin, @Raporty, @Kierownik, @KadryId, @KadryId2, @RcpId, @Status, @RcpStrefaId, @RcpAlgorytm, @CCInfo, @Rights, @IdLinii, @GrSplitu, @DataZatr, @DataZwol, 1, 1, 0, @OkresProbnyDo)
set @IdPracownika = (select @@Identity)

update Pracownicy set Login = Login + KadryId where Login = 'login_' and Id = @IdPracownika
update Pracownicy set Email = Email + KadryId where Email = 'email_' and Id = @IdPracownika
