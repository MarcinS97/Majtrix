<%@ Page Title="" Language="C#" MasterPageFile="~/MatrycaSzkolen/MS.Master" AutoEventWireup="true" CodeBehind="Zgloszenie.aspx.cs" Inherits="HRRcp.MatrycaSzkolen.Zgloszenie" %>

<%@ Register src="~/Controls/PageTitle.ascx" tagname="PageTitle" tagprefix="uc2" %>
<%@ Register Src="~/MatrycaSzkolen/Controls/cntKartaZgloszenie.ascx" TagPrefix="cc" TagName="cntZgloszenie" %>
