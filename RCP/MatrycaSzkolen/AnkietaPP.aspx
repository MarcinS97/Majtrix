<%@ Page Title="" Language="C#" MasterPageFile="~/MatrycaSzkolen/MS.Master" AutoEventWireup="true" CodeBehind="AnkietaPP.aspx.cs" Inherits="HRRcp.MatrycaSzkolen.AnkietaPP" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="caption4 caption">
        ...
        <asp:LinkButton ID="btnBack" runat="server" Text="Powrót" CssClass="btn btn-sm btn-default pull-right" PostBackUrl="~/MatrycaSzkolen/Ewaluacja.aspx" Visible="false" />
    </div>
    ...
    <div class="pgKartaZgloszenie center960">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <cc:cntAnkietaP ID="cAnkietaP" runat="server" PracView="true" />
            </ContentTemplate>
            <%--<Triggers>
