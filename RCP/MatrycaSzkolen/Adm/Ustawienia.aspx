<%@ Page Title="" ValidateRequest="false" Language="C#" MasterPageFile="~/MatrycaSzkolen/MS.Master" AutoEventWireup="true" CodeBehind="Ustawienia.aspx.cs" Inherits="HRRcp.MatrycaSzkolen.Adm.Ustawienia" %>
...
--%>
<%@ Register src="~/MatrycaSzkolen/Controls/Adm/AdmInfoControl.ascx" tagname="AdmInfoControl" tagprefix="uc3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="pgUstawienia">

    <uc2:PageTitle ID="PageTitle1" runat="server" Title="Ustawienia" SubText1="Ustawienia systemu" />
        ...
        <ContentTemplate>
            <asp:Menu ID="tabUstawienia" runat="server" Orientation="Horizontal" 
                ...
                <Items>
                    ...
                    <%--<asp:MenuItem Text="Teksty" Value="1" Selected="true" ></asp:MenuItem>--%>
                    <asp:MenuItem Text="Powiadomienia mailowe" Value="4"></asp:MenuItem>
                    <asp:MenuItem Text="Scheduler" Value="5"></asp:MenuItem>
                    <asp:MenuItem Text="Scheduler - TETA" Value="6"></asp:MenuItem>
            ...
            <div class="tabsContent" style="border-collapse:collapse; background-color:#FFF;">
                <div class="content">
                <asp:MultiView ID="mvPracownicy" runat="server" ActiveViewIndex="1">
                    ...
                    <asp:View ID="pgTeksty" runat="server">
                        ...
                        <div class="bottom_buttons" >
                            ...
                            <asp:Button ID="btImportTeksty" runat="server" CssClass="xbutton100 btn btn-sm btn-default" Text="Import" onclick="btImportTeksty_Click" OnClientClick="javascript:return checkFile();" />
                            <asp:Button ID="btExportTeksty" runat="server" CssClass="xbutton100 btn btn-sm btn-default" Text="Eksport" onclick="btExportTeksty_Click" />
                        </div>
                    </asp:View>
                    ...
                    <asp:View ID="View2" runat="server">
                        <uc3:cntSchedulerAdm ID="cntSchedulerAdm" runat="server" NotGrupa="TETA"/>
                    </asp:View>

                    <asp:View ID="View6" runat="server">
                        <uc3:cntSchedulerAdm ID="cntSchedulerAdm1" runat="server" Grupa="TETA"/>
                    </asp:View>
                </asp:MultiView>
                </div>    
            </div>
