<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="RepCCPracownicy.aspx.cs" Inherits="HRRcp.RepCCPracownicy" %>
...
join ccPrawa PC on PC.UserId = @UserId and PC.CC = S.TypImport  --S.Class
        "
        P2="
...
and ('@p3' = '*' or '@p3' = S.cc)
and ('@p4' = '*' or '@p4' = S.TypImport) --S.Class)
