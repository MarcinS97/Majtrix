<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="RPracownicyCC.aspx.cs" Inherits="HRRcp.RPracownicyCC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderReport" runat="server">
    <uc1:cntReport ID="cntReport1" runat="server" 
        Title="select 'Pracownicy pracujący na ' + cc + ' - ' + Nazwa from CC where Id = @p1"
        Title2="select
case when '@p2' = '@p3' then 
        'Dzień: @p2'
else    'Okres: @p2 do @p3'
end"
        Title3="select 'Nadgodziny ''' + case when @p4 = 150 then '50+100' else '@p4' end"
        SQL1="
