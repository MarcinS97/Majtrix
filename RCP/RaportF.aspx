<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="RaportF.aspx.cs" Inherits="HRRcp.RaportF" EnableEventValidation="true" %>
...
--%>
                <asp:HiddenField ID="Params" runat="server" Visible="false" />            
                <uc1:cntModal runat="server" ID="cntModal" Visible="false" CloseButtonText="Anuluj" >
                    <ContentTemplate>
                        <asp:PlaceHolder runat="server" id="phModal" >
                        </asp:PlaceHolder>
                        <asp:Label ID="lbModalError" runat="server" Visible="false" Text="Niepoprawna nazwa kontrolki."></asp:Label>
                    </ContentTemplate>
                    <FooterTemplate>
                        <asp:Button ID="btModalOk" runat="server" CssClass="btn btn-success" OnClick="btModalOk_Click" Visible="false" Text="Ok" />
                    </FooterTemplate>
                </uc1:cntModal>
            </div>          
        </ContentTemplate>
