    ...
    public partial class WnioskiUrlopoweForm : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                App.KwitekPracId = db.getScalar("select Id from Pracownicy where KadryId = " + db.strParam(App.KwitekKadryId));
        ...
        protected void cntWnioskiUrlopoweSelect1_Select(object sender, EventArgs e)
        {
            ...
            if (wtyp != -1)
            {
                ...
                //TODOcntWniosekUrlopowy1.PrepareNewPopup(extWniosekPopup, wtyp, cntWniosekUrlopowy.osPracownik);
                //cntModal.Show(false);
                cntWniosekUrlopowy2.PrepareNew(wtyp, cntWniosekUrlopowy.osPracownik);
        ...
        protected void cntWnioskiUrlopowe1_Show(object sender, EventArgs e)
        {
            ...
            //TODO
            cntWniosekUrlopowy2.Show(cntWnioskiUrlopowe1.ShowWniosekId, cntWniosekUrlopowy.osPracownik, false);
            UpdatePanel5.Update();    // jezeli wywołanie jest z updatepanel to trzeba też zrobić update
        }

        protected void cntWnioskiUrlopowe1_Hide(object sender, EventArgs e)
        {
            //TODOcntWniosekUrlopowy1._Clear();
