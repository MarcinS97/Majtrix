<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="WnioskiUrlopoweWpisz.aspx.cs" Inherits="HRRcp.Portal.WnioskiUrlopoweWpisz" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderReport" runat="server">
    <div class="paWnioskiUrlopoweWpisz">
        ...
        <div class="paWnioskiUrlopoweWpisz2 container wide">
            ...
            <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional" >
                <ContentTemplate>
                    ...
                    <div class="tabsContent bg-white" >
                        <asp:MultiView ID="mvWnioski" runat="server" ActiveViewIndex="0">
                            ...
                            <asp:View ID="vDoWprowadzenia" runat="server" onactivate="vDoWprowadzenia_Activate">
                                <div class="padding">
                                    ...
                                    <asp:Button ID="btNext" CssClass="button btn btn-primary" runat="server" Text="Wprowadzony, zaznacz następny" onclick="btNext_Click" Visible="false"/>
                                    <%--
