...
{
    public partial class ZwolnieniaForm : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ImieNazwisko1.Prepare(App.KwitekKadryId);
                cntZwolnienia.Prepare(App.KwitekKadryId);
                if (Lic.portalPrint)
