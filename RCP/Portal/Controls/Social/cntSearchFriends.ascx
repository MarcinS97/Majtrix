<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntSearchFriends.ascx.cs" Inherits="HRRcp.Portal.Controls.Social.cntSearchFriends" %>
...
<style type="text/css">
    .cntSearchFriends { }
        ...
        .cntSearchFriends .friend-card { padding: 8px; border: solid 1px #eee; height: 190px; margin-bottom: 16px; background-color: #fff; border: solid 1px #eee; border-radius: 2px; }
            ...
            .cntSearchFriends .friend-card .name { font-size: 18px; }
    ...
    <asp:UpdatePanel ID="upMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="search-content">
                ...
                <asp:ListView ID="lvSearch" runat="server" DataSourceID="dsSearch">
                    <LayoutTemplate>
...
<asp:SqlDataSource ID="dsSearch" runat="server" ConnectionString="<%$ ConnectionStrings:PORTAL %>" CancelSelectOnNullParameter="false"
    SelectCommand="select top 10 *, Nazwisko + ' ' + Imie Pracownik 
    from Pracownicy p
