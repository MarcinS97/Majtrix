...
{
    public partial class cntWnioskiUrlopowe3 : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            #endif
            dsPracaZdalna.SelectCommand = String.Format(dsPracaZdalna.SelectCommand, typPrzypisan);
            SqlDataSource1.SelectCommand = String.Format(SqlDataSource1.SelectCommand, funkcjaPrzypisan);
            SqlDataSource2.SelectCommand = String.Format(SqlDataSource2.SelectCommand, funkcjaPrzypisan, typPrzypisan);
...
where W.StatusId = @stAcc and W.Wprowadzony = 1 and A.Id is not null
        ...
        protected void lvWnioski_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            //SqlDataSource s = Tools.FindControl(this, "dsSciezkaAkceptacji") as SqlDataSource;
            //s.SelectParameters["Id"].DefaultValue = drv["Id"].ToString();
