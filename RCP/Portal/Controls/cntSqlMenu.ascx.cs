    ...
    public partial class cntSqlMenu : System.Web.UI.UserControl
    {
        ...
        */
        ...
        protected void ListView1_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            ...
            {
                case "EditModal":
                    //string id = ListView1.DataKeys[e.ItemIndex].ToString()

                    ListViewDataItem dataItem = (ListViewDataItem)e.Item;
                    string id = ListView1.DataKeys[dataItem.DisplayIndex].Value.ToString();

                    cntSqlMenuEditModal.Show(id);
        ...
        {
            cntSqlMenuEditModal.Show();
            if (!String.IsNullOrEmpty(ddlGrupa.SelectedValue))
                cntSqlMenuEditModal.SetGrupa(ddlGrupa.SelectedValue);
        }

        protected void cntSqlMenuEditModal_Saved(object sender, EventArgs e)
        {
            upMain.Update();
            ListView1.DataBind();
