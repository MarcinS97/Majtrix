<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="WniosekWolneZaNadg.aspx.cs" Inherits="HRRcp.RCP.WniosekWolneZaNadg" %>
<%@ Register src="~/RCP/Controls/Raporty/cntWniosekWolneZaNadg.ascx" tagname="cntWniosekWolneZaNadg" tagprefix="uc1" %>
<%@ Register src="~/RCP/Controls/Raporty/cntWniosekWolneZaNadgKier.ascx" tagname="cntWniosekWolneZaNadgKier" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <%-- <div class="center">
    ...
    <div class="pgWniosekWolneZaNadg printoff">
