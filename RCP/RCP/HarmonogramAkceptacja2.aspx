<%@ Page Title="" Language="C#" MasterPageFile="~/RCP/RCP.master" AutoEventWireup="true" CodeBehind="HarmonogramAkceptacja2.aspx.cs" Inherits="HRRcp.RCP.HarmonogramAkceptacja2" %>
<%@ Register Src="~/Controls/PageTitle.ascx" TagPrefix="uc1" TagName="PageTitle" %>
<%@ Register Src="~/RCP/Controls/cntHarmonogramAcc2.ascx" TagPrefix="uc1" TagName="HarmonogramAcc" %>
