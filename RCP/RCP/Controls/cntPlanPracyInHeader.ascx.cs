...
{
    public partial class cntPlanPracyInHeader : System.Web.UI.UserControl
    {
        ...
        cntPlanPracyLineHeader plHeader = null;

        public void DataBind(cntPlanPracyLineHeader ph, int typ, bool vis1)
        {
            plHeader = ph;
...
#endif
                    if (p1 != null) p1 = cntPlanPracyLine2.DecodeHtml(p1);
                    if (p2 != null) p2 = cntPlanPracyLine2.DecodeHtml(p2);
