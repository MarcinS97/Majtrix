<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntPlanPracyZmiany.ascx.cs" Inherits="HRRcp.RCP.Controls.cntPlanPracyZmiany" %>
...
<asp:SqlDataSource ID="dsPrint2Comp" runat="server" SelectCommand="select Klasyfikacja from PracownicyStanowiska where IdPracownika = {0} and {1} between Od and ISNULL(Do, '20990909')" />
