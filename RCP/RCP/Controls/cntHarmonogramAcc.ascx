<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cntHarmonogramAcc.ascx.cs" Inherits="HRRcp.RCP.Controls.cntHarmonogramAcc" %>
<%@ Register Src="~/Controls/Portal/cntSqlTabs.ascx" TagPrefix="cc" TagName="cntSqlTabs" %>

<%@ Register Src="~/RCP/Controls/cntPlanPracy.ascx" TagPrefix="uc1" TagName="PlanPracy" %>
