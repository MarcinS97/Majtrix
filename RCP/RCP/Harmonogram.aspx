<%@ Page Title="" Language="C#" MasterPageFile="~/RCP/RCP.Master" AutoEventWireup="true" CodeBehind="Harmonogram.aspx.cs" Inherits="HRRcp.RCP.Harmonogram" %>

<%@ Register Src="~/Controls/PageTitle.ascx" TagPrefix="uc1" TagName="PageTitle" %>
<%@ Register Src="~/RCP/Controls/cntPlanPracyZmiany.ascx" TagPrefix="uc1" TagName="cntPlanPracyZmiany" %>
