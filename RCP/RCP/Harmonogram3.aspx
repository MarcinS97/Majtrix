<%@ Page Title="" Language="C#" MasterPageFile="~/RCP/RCP.master" AutoEventWireup="true" CodeBehind="Harmonogram3.aspx.cs" Inherits="HRRcp.RCP.Harmonogram3" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-page pgHarmonogram">
        <uc1:cntHarmonogramWrapper runat="server" ID="cntHarmonogramWrapper" Mode="Plan" />
    </div>
</asp:Content>
