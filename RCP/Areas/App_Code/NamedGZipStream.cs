...
//http://msdn.microsoft.com/pl-pl/magazine/cc163727(en-us).aspx
//http://msdn.microsoft.com/pl-pl/magazine/cc164653(en-us).aspx
//http://msdn.microsoft.com/en-us/library/system.io.compression.gzipstream.aspx#Y2775
...
namespace HRRcp.App_Code
{
    public class NamedGZipStream : DeflateStream
	{
			...
			: base(output, CompressionMode.Compress, true)
		{
			...
			byte [] header = { 0x1f, 0x8b, 0x8, 0x8, 0, 0, 0, 0, 4, 0 };
		...
		// See RFC1952 for details. http://www.faqs.org/rfcs/rfc1952.html
